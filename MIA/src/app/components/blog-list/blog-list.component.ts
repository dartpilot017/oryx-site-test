...
export class BlogListComponent {
  ...
  buttons: Button[] = [
    { text: 'View all', selected: true },
    { text: 'ERP', selected: false },
    { text: 'HR', selected: false },
    { text: 'Payroll', selected: false },
    { text: 'Business Management', selected: false },
    { text: 'Application Development', selected: false },
  ];
